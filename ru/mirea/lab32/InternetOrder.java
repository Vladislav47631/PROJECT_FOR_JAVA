...
public class InternetOrder implements Order {
    ...
    public String toString() {
        String result = "Позиций заказа техники: " + this.size + " ; Заказчик: " + this.customer.toString() + "\n";
    ...
    {
        String result = customer.getFirstName() + " " + customer.getSecondName() + " " + customer.getAge() + " " + customer.getAddress().fileString() + " " + this.size;
        for (int i = 0; i < this.size; ++i)
        {
