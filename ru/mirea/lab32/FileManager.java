                    ...
                    for (int i = 0; i < length; ++i)
                    {
                        if (scanner.next().equals("null") == false) {
                            ...
                            for (int j = 0; j < menuItems[i].length; ++j) {
                                if (scanner.next().equals("NameComputer") == true) {
                                    nameItem = "";
                                    do {
                                    ...
                                    menuItems[i][j] = new NameComputer(price, nameItem, description);
                                }
                                else {
                                    type =  scanner.next();
                                    nameItem = "";
                                    ...
                                    menuItems[i][j] = new NamePhone(price,nameItem,description,alcoholDegree, NamePhoneTypeEnum.get(type));
                                }
                            }
            ...
            if(!file.exists()){
                ...
                try {
                    ...
                    for (int i = 0; i < size; ++i)
                    {
                        ...
                        menuItems[i] = new MenuItem[scanner.nextInt()];
                        for (int j = 0; j < menuItems[i].length; ++j) {
                            if (scanner.next().equals("Компьютер") == true) {
                                nameItem = "";
                                do {
                                    nameItem += scanner.next();
                                    if (nameItem.charAt(nameItem.length() - 1) != '\'') {
