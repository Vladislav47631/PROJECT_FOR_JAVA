...
public class Drink extends MenuItem implements Alcoholable {
    ...
    public String toString() {
        ...
        return "Drink: " + var10000 + " " + this.name + " - " + this.price + " ,Alcohol " + this.alcoholDegree + " % - " + this.description;
    }

    public String fileString()
    {
        String result = "Drink " + String.valueOf(this.typeEnum) + " '" + this.name + "' " + this.price + " " + this.alcoholDegree + " '" + this.description + "'";
