...
public class TableOrdersManager implements OrderManager {
    ...
    public void add(Order order, int table_number)
    {
        this.orders[table_number] = order;
        ++size;
    }
    ...
    public boolean resizeTable(int new_lenght)
    {
        if (new_lenght > this.orders.length)
        {
            resize(new_lenght);
            return true;
        }
        else if (new_lenght == this.orders.length)
        {
            return false;
        }
        else
